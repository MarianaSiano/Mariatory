...
<body>
    ...
    <div class="modalllll hide mvizualizar" id="modalVizualizar">
        <div class="headerModal">
        ...
        <div class="tudo">
            ...
            <div class="campoPreencher">
                <div class="campos">
                    <p id="nomeUsuario">Nome do usuário:</p>
                    <input readonly class="Nome"  placeholder="Nome do usuário" />
                    <p id="nomeUsuario">E-mail:</p>
                    <input readonly class="email" placeholder="E-mail" />
                    <p id="nomeUsuario">Senha:</p>
                    <input readonly class="senha" placeholder="Senha" type="password"/>
                </div>
            </div>
    ...
    <div class="heading">
        <form class="formulario">
            ...
            <div class="btnBusca">
                <button type="submit" class="busca"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="btnUsuario">
                <button class="usuario clique" type="button" data-modal="modalAddUser"><svg
